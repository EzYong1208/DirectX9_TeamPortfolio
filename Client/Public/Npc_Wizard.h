...
class CNpc_Wizard : public CGameObject
{
public:
	explicit CNpc_Wizard(LPDIRECT3DDEVICE9 _pGraphic_Device);
	explicit CNpc_Wizard(const CNpc_Wizard& rhs);
	virtual ~CNpc_Wizard() = default;
...
public:
	static CNpc_Wizard*			Create(LPDIRECT3DDEVICE9 _pGraphic_Device);
