...
class CNpc_ShopGuyEpic : public CGameObject
{
public:
	explicit CNpc_ShopGuyEpic(LPDIRECT3DDEVICE9 _pGraphic_Device);
	explicit CNpc_ShopGuyEpic(const CNpc_ShopGuyEpic& rhs);
	virtual ~CNpc_ShopGuyEpic() = default;
...
public:
	static CNpc_ShopGuyEpic*	Create(LPDIRECT3DDEVICE9 _pGraphic_Device);
